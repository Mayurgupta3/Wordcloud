#Import the main library like wordcloud, matplotlib
from wordcloud import WordCloud, STOPWORDS
import matplotlib.pyplot as plt

#This is the string from which the word is selected for the wordcloud, You can change the string.
...
plt.axis("off")
#To show the worcloud, from which you can download it
plt.show()
